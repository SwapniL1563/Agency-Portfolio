  ...
  return (
   ...
   <Marquee   className="hidden lg:flex absolute z-10 left-0 lg:bottom-14  xl:bottom-10 bg-black py-4 lg:py-6 mr-2 xl:py-8 ">
     ...
     <h1 className=" ml-40 text-2xl text-neutral-200"> Transforming Ideas into Digital Reality</h1>
      <img className="animate-spin1" src="assets/planet.png" alt="" />
   ...
   <img src="/assets/glow.png" className='absolute top-32  animate-pulse1' alt="" ></img>
   <img src="/assets/glow.png" className='absolute right-0 bottom-[-10%] animate-pulse1 rotate-180' alt=""></img>
