...
import glow from "/blob/main/src/assets/glow.png"

const Hero = () => {
  return (
   <>
   <div className="hero z-10 flex justify-center  lg:px-12 md:px-4 px-0  relative " >
    <div className="container z-10 bg-[url('/src/assets/bg-home.png')] bg-center lg:bg-top  lg:rounded-2xl lg:border-[#6F008F] lg:border-[1.5px] bg-cover h-[600px]  bg-no-repeat flex justify-center  ">      {/* <img className='lg:w-[94%] opacity-[100%]' src="/src/assets/Home-bg.png" alt="" /> */}
   ...
   <img src={ glow } className='absolute right-0 bottom-[-10%] animate-pulse1 rotate-180' alt="" />
