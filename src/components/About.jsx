    ...
    <div className='flex lg:mt-28 mt-16 z-10 justify-center items-center relative'>
        <div className="container z-10 lg:w-[80%] w-[95%] glass1 py-4 flex flex-wrap rounded-lg">
           ...
           <div className="img  flex justify-center items-center lg:mb-0 mb-6">
                <img src="/src/assets/Service-bg.png" className alt=""></img>
            </div>
        ...
        <img src="public/assets/glow.png" className='hidden lg:flex lg:absolute left-0  animate-pulse1 z-0 ' alt="" ></img>
        <img src="/public/assets/glow.png" className='hidden lg:flex lg:absolute right-0  animate-pulse1 z-0 rotate-180' alt="" ></img>
    </div>
  )
}
