...
const About = () => {
  return (
    <div className='flex lg:mt-28 mt-16 z-10 justify-center items-center relative'>
        ...
        <img src={glowservice} className='hidden lg:flex lg:absolute left-0  animate-pulse1 z-0 ' alt="" />
        <img src={glowservice} className='hidden lg:flex lg:absolute right-0  animate-pulse1 z-0 rotate-180' alt="" />
    </div>
  )
}
